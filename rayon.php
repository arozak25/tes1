	...
	<form method="post">
		<table align="center">
			<tr>
				<td>Rayon</td>
				<td>:</td>
				<td><input type="text" name="rayon" value="<?php echo @$edit['rayon']?>"></input></td>
			</tr>
			<tr>
				<td></td>
				<td></td>
	...
	<br />
		<table align="center">
			...
			<tr>
				...
				<td><a href="?menu=rayon&edit&id=<?php echo @$r['id_rayon'] ?>">Edit</a></td>
				<td><a href="?menu=rayon&hapus&id=<?php echo @$r['id_rayon'] ?>">Hapus</a></td>
			</tr>
			<?php }
			} ?>
		</table>
